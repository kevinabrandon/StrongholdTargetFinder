...
#  03-ConvexHulls.py
#
#  Third lesson in a tutorial for detecting a target in opencv using python on a raspberry pi.
#  This lesson we detect look at the convex hull of each contour.
#
...
for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
	...
	hulls = [] # a list of hulls, that we will fill in below:
	...
	# draw the hulls instead of the contours.
