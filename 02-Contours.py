...
#  02-Contours.py
#
#  Second lesson in a tutorial for detecting a target in opencv using python on a raspberry pi.
#  This lesson we detect all the countours in the image and draw them to the screen.
#
...
for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
	...
	# draw the raw contours on top of the image:
	cv2.drawContours(drawnImage, contours, -1, green, 3)
