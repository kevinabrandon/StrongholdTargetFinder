...
#		7. Find the center of the target and measure it's angle in the field of view of the camera.
#
...
for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
	...
	for target in finalTargets:
		...
		cv2.line(drawnImage, (cx-2, cy), (cx+2, cy), red, 2)	# little horizontal line
		cv2.line(drawnImage, (cx, cy-2), (cx, cy+2), red, 2)	# little vertical line
