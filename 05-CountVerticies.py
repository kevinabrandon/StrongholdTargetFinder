#
#  05-CountVerticies.py
#
#  Fifth lesson in a tutorial for detecting a target in opencv using python on a raspberry pi.
#  This lesson we aproximate the convex hulls, and count the number of verticies... we only keep those that have exactly 4.
#
#	Also, an auto exposure algorithim has been added.
#
...
#		5. Approximates the hull in order to get only 4 points 
#
...
cv2.createTrackbar('threshold', winName, 25, 255, nothing)  # the threshold value
